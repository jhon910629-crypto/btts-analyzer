...
export async function POST(request: NextRequest) {
  ...
  const prompt = `Haz un análisis profundo de probabilidad BTTS (ambos equipos anotan) para el partido ${equipoLocal} vs ${equipoVisitante} programado para ${fecha}. Investiga: % BTTS de los últimos 5-10 partidos de cada equipo, promedio de goles a favor y en contra, rendimiento como local/visitante, racha de porterías a cero, lesiones/sanciones relevantes y contexto motivacional (posición en tabla, importancia del partido).
